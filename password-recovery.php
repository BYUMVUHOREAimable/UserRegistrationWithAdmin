...
if (isset($_POST['send'])) {
    ...
    $femail = mysqli_real_escape_string($con, $_POST['femail']); // Sanitize input
    ...
    if (mysqli_num_rows($row1) > 0) {
        ...
        $mail->setFrom('your_email@gmail.com', 'Your Name'); // Your Gmail address
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <div class="small mb-3 text-muted">Enter your email address and we will send you your password on your email</div>
                                    <form method="post">
